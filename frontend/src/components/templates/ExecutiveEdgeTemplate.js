...
const ExecutiveEdgeTemplate = ({ data }) => {
  const {
    personalInfo = {},
    experience   = [],
    education    = [],
  ...
  return (
    <div className="template executive-edge-template">
      
      {/* Header */}
      <div className="executive-edge-header">
      ...
      {experience && experience.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title executive-edge-title">Experience</h2>
      ...
      {projects && projects.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title executive-edge-title">Projects</h2>
      ...
      {hasSkills && (
        <div className="t-section">
          <h2 className="t-section-title executive-edge-title">Skills</h2>
      ...
      {education && education.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title executive-edge-title">Education</h2>
...
export default ExecutiveEdgeTemplate;
