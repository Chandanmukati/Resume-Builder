...
const StandoutTemplate = ({ data }) => {
  ...
  return (
    <div className="template standout-template">
      ...
      {experience && experience.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title standout-title">Experience</h2>
      ...
      {projects && projects.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title standout-title">Projects</h2>
      ...
      {hasSkills && (
        <div className="t-section">
          <h2 className="t-section-title standout-title">Skills</h2>
      ...
      {education && education.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title standout-title">Education</h2>
