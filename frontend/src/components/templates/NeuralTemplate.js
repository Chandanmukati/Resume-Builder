...
const NeuralTemplate = ({ data }) => {
  ...
  return (
    <div className="template neural-template">
      ...
      {experience && experience.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title neural-title">Experience</h2>
      ...
      {projects && projects.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title neural-title">Projects</h2>
      ...
      {hasSkills && (
        <div className="t-section">
          <h2 className="t-section-title neural-title">Skills</h2>
      ...
      {education && education.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title neural-title">Education</h2>
