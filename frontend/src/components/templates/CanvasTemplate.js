...
const CanvasTemplate = ({ data }) => {
  ...
  return (
    <div className="template canvas-template">
      ...
      {experience && experience.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title canvas-title">Experience</h2>
      ...
      {projects && projects.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title canvas-title">Projects</h2>
      ...
      {hasSkills && (
        <div className="t-section">
          <h2 className="t-section-title canvas-title">Skills</h2>
      ...
      {education && education.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title canvas-title">Education</h2>
