...
const VividTemplate = ({ data }) => {
  ...
  return (
    <div className="template vivid-template">
      
      {/* Header */}
      <div className="vivid-header">
      ...
      {experience && experience.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title vivid-title">Experience</h2>
      ...
      {projects && projects.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title vivid-title">Projects</h2>
      ...
      {hasSkills && (
        <div className="t-section">
          <h2 className="t-section-title vivid-title">Skills</h2>
      ...
      {education && education.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title vivid-title">Education</h2>
