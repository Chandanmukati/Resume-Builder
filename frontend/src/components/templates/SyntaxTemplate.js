...
const SyntaxTemplate = ({ data }) => {
  ...
  return (
    <div className="template syntax-template">
      ...
      {experience && experience.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title syntax-title">Experience</h2>
      ...
      {projects && projects.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title syntax-title">Projects</h2>
      ...
      {hasSkills && (
        <div className="t-section">
          <h2 className="t-section-title syntax-title">Skills</h2>
      ...
      {education && education.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title syntax-title">Education</h2>
