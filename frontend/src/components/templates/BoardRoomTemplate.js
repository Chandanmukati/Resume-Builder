...
const BoardRoomTemplate = ({ data }) => {
  ...
  return (
    <div className="template board-room-template">
      ...
      {experience && experience.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title board-room-title">Experience</h2>
      ...
      {projects && projects.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title board-room-title">Projects</h2>
      ...
      {hasSkills && (
        <div className="t-section">
          <h2 className="t-section-title board-room-title">Skills</h2>
      ...
      {education && education.length > 0 && (
        <div className="t-section">
          <h2 className="t-section-title board-room-title">Education</h2>
